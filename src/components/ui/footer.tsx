        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                {/* Logo */}
                <a href="/" className="inline-block" aria-label="Rashtan Soft">
                  <svg
              ...
              <div className="text-gray-400">
                Rashtan-Soft stands at the forefront of technology, specializing
                in delivering custom solutions with a strong proficiency in C#,
                React, and Node.js. We not only cater to the specific needs of
                our clients by building tailored software but also innovate
                within the tech space by developing and marketing our own
                products.
              </div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <a
                  href="https://www.linkedin.com/in/gavrilo-mumovic/"
                  className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out"
                  aria-label="Linkedin"
                >
                  <svg
